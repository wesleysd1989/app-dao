...
const App = () => {
  ...
  const token = useToken("0x179D14939D809958EAb36d3D07BA3fBAB908aB32");
  const vote = useVote("0x8fbfEB85dE56ceb5d0430642B8509Fc25244c0C0");
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Bem-vind@s à DONATEDAO a DAO dos pedaleiros de montanha</h1>
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        ...
        <p>Parabéns por fazer parte desse clube de DONATORS!!!</p>
        <div>
          <div>
  ...
  return (
    <div className="mint-nft">
      <h1>Cunhe gratuitamente seu NFT de membro da DONATEDAO</h1>
